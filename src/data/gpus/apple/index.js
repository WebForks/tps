...
export default [
  ...
  { id: 'apple_m5_max_128g', name: 'Apple M5 Max (128GB)', vendor: 'apple', tier: 'consumer', released: '2026-03', vram: 128, bw: 614, bwUtilization: 0.99, bf16: 27.0, int8: 54.0, int4: null, nvlink_bw: null, tdp: 70, unifiedMemory: true, usableRatio: 0.85 },
  { id: 'apple_m5_max_64g',  name: 'Apple M5 Max (64GB)',  vendor: 'apple', tier: 'consumer', released: '2026-03', vram: 64,  bw: 614, bwUtilization: 0.99, bf16: 27.0, int8: 54.0, int4: null, nvlink_bw: null, tdp: 70, unifiedMemory: true, usableRatio: 0.85 },
  { id: 'apple_m5_max_48g',  name: 'Apple M5 Max (48GB)',  vendor: 'apple', tier: 'consumer', released: '2026-03', vram: 48,  bw: 614, bwUtilization: 0.99, bf16: 27.0, int8: 54.0, int4: null, nvlink_bw: null, tdp: 70, unifiedMemory: true, usableRatio: 0.85 },
  // 32-core GPU, 460 GB/s
  { id: 'apple_m5_max_36g',  name: 'Apple M5 Max (36GB, 32-core GPU)',  vendor: 'apple', tier: 'consumer', released: '2026-03', vram: 36,  bw: 460, bwUtilization: 0.90, bf16: 20.2, int8: 40.4, int4: null, nvlink_bw: null, tdp: 62, unifiedMemory: true, usableRatio: 0.85, decodeBwScale: 1.0, gpuCores: 32 },
  // ── M5 Ultra ────────────────────────────────────────
  ...
  { id: 'apple_m5_pro_24g',  name: 'Apple M5 Pro (24GB, 16-core GPU)',  vendor: 'apple', tier: 'consumer', released: '2026-03', vram: 24,  bw: 307, bwUtilization: 0.82, bf16: 13.5, int8: 27.0, int4: null, nvlink_bw: null, tdp: 38, unifiedMemory: true, usableRatio: 0.85, decodeBwScale: 0.77, gpuCores: 16 },
  ...
  { id: 'apple_m4_pro_24g',  name: 'Apple M4 Pro (24GB, 16-core GPU)',  vendor: 'apple', tier: 'consumer', released: '2024-11', vram: 24,  bw: 273, bwUtilization: 0.82, bf16: 10.6, int8: 21.2, int4: null, nvlink_bw: null, tdp: 38, unifiedMemory: true, usableRatio: 0.85, decodeBwScale: 0.77, gpuCores: 16 },
  // ── M4 ──────────────────────────────────────────────
